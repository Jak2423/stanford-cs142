...
(function () {
	...
	var im = { _id: '57231f1a30e4351f4e9f4bd7', first_name: 'Ian', last_name: 'Malcolm', location: 'Austin, TX', description: "Should've stayed in the car.", occupation: 'Mathematician' };
	var er = { _id: '57231f1a30e4351f4e9f4bd8', first_name: 'Ellen', last_name: 'Ripley', location: 'Nostromo', description: 'Lvl 6 rating. Pilot.', occupation: 'Warrant Officer' };
	var pt = {
	...
	var rk = { _id: '57231f1a30e4351f4e9f4bda', first_name: 'Rey', last_name: 'Kenobi', location: "D'Qar", description: 'Excited to be here!', occupation: 'Rebel' };
	var al = { _id: '57231f1a30e4351f4e9f4bdb', first_name: 'April', last_name: 'Ludgate', location: 'Pawnee, IN', description: 'Witch', occupation: 'Animal Control' };
	var jo = { _id: '57231f1a30e4351f4e9f4bdc', first_name: 'John', last_name: 'Ousterhout', location: 'Stanford, CA', description: '<i>CS142!</i>', occupation: 'Professor' };
